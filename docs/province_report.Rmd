---
title: "GLOSS - Groundwater Level Forecast Report"
output: 
  html_document:
    self-contained: true
params:
...
Forecasts provide a range of likely conditions and are presented as likelihoods of groundwater being above, below, or near normal. This analysis uses the “normal” term solely in reference to water levels between the 25th to 75th percentiles of historical data, not to imply a steady state baseline for comparison. Data should be interpreted with the context of long-term records, patterns, and trends. 
