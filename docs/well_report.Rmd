...
\textbf{Model Description}: The model provides water level forecasts up to 90 days in advance. It uses artificial neural networks, a type of machine learning, to relate groundwater levels to historic precipitation `r ifelse(params$model_type == "Rain-Dominated Model", "and temperature data", "temperature, and snowpack data")`. The model also accounts for recharge lag times, capturing how groundwater responds to hydroclimate data. Forecasts provide a range of likely conditions and are presented as likelihoods of groundwater being above, below, or near normal.
