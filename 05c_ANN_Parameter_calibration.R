...
#### Validation testing ####
source("Groundwater Level Forecasting Toolkit Phase 2 V2.0/functions/ANN_hyperparameter_calibration.R")
  

ANN_hyper_parameters <- ANN_hyper_parameters_calibration(Time_series_data, pgown_well_info, forecast_test_length, num_cores, output_path)

#summarise Statistics
location <- paste0(output_path,"/ANN_hypercalibration_results_",i,".csv") 
write.csv(ANN_hyper_parameters, file = location)
