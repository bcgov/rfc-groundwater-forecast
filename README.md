...
Results of the GLOSS forecast model can be found on the Groundwater Level Forecast [Map](https://nrs.objectstore.gov.bc.ca/rfc-conditions/groundwater_forecast/outputs/Groundwater_Level_Forecast_Map.html) 
